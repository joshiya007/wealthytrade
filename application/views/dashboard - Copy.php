    	...
    	<div class="sidebar-wrapper">
            <div class="logo">
                <a href="dashboard" class="simple-text">
                    <h4 class="title text-center "><a href="dashboard" class="login-header-h4">test<span>aid</span></a></h4>
        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a href="dashboard" class="navbar-brand login-header-h4">Dash<span>board</span></a>
                </div>
