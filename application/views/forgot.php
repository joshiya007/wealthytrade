                                ...
                                <div class="col-md-12">
                                    <form method="post" accept-charset="utf-8" id="loginform" role="form" class="form-horizontal" action="#">
                                        <div class="form-group sliding-u-r-l">
                                            ...
                                            <input type="email" class="form-control" autosuggest="false" name="email" value="" id="emailid" placeholder="Email ID*" tabindex="1" required>
                                        </div>
                                        <br>
                                        ...
                                        <div class="form-group pull-right">              
                                            <button type="submit" name="" id="submit" tabindex="5" class="btn btn-success button">Submit</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
